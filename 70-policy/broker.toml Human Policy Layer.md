...
- 2026-09-24 (M3): keys `protocol = "github"`, `verbs` (known verbs only; empty denies), `repos` (absent: the task repository) and `credential.risk` (`standard` or `high`) ([[ADR-029 GitHub API Adapter and Session Labels as Built]]).
