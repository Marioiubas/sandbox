...
- 2026-09-24: status `built`: record, mine, prove, review, shadow and enforce all run locally; deferrals (LLM explanation, `--pr`, G1) in [[ADR-028 M2 Plan Items Built Differently or Deferred]].
